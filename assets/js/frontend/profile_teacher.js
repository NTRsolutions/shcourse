...
$(window).ready(function () {
    ...
    function Share_make_Item(orderNum,item_title,item_id){
        ...
        output_html += '<a href="' + baseURL+'community/view/' +item_id+'" class="share_item_title" style = "top:'+item_top_str+'">';
        ...
        $.ajax({
            ...
            success:function(res){
                if(res.status=='success'){
                    alert("This is my final item"+res.data);
    ...
    function comment_make_Item(orderNum,item_title,item_id){
        ...
        output_html += '<a href="' + baseURL+'community/view/' +item_id+'" class="comment_item_title" style = "top:'+item_top_str+'">';
        output_html += item_title;
        output_html += '</a>';
    ...
    classManBtn.mouseover(function(){ $(this).css({"background":"url("+imageDir+"classmanage_hover.png) no-repeat",'background-size' :'100% 100%'}); });
    classManBtn.mouseout(function(){ $(this).css({"background":"url("+imageDir+"classmanage.png) no-repeat",'background-size' :'100% 100%'}); });
