...
<div class="hidden_edit_fields"  style="display: none">
    ...
    <div class="student_banji_edit">
        <select class="form-control" id="banji_select">
        </select>
     </div>
    <div class="student_gender_edit">
    ...
    <div class="student_nickname_edit">
        <input type="text" class="form-control" id="nickname_input"  value="<?php echo $student->nickname;?>">
    </div>
    <div class="student_serialnum_edit">
        <input type="text" class="form-control" id="serialno_input"  value="<?php echo $student->serial_no;?>">
    </div>
</div>
<style>
    .student_nianji_edit {position: absolute;display: table;width: 10%;height: 5%;left: 36%;top: 28%;}
    .student_banji_edit{position: absolute;display: table;width: 10%;height: 5%;left: 36%;top: 35.5%;}
    .student_gender_edit {position: absolute;display: table;width: 10%;height: 5%;left: 36%;top: 43%;}
    .student_fullname_edit{position: absolute;display: table;width: 10%;height: 5%;left: 60.2%;top: 21%;}
    .student_nickname_edit{position: absolute;display: table;width: 10%;height: 5%;left: 60.2%;top: 35.5%;}
    .student_serialnum_edit {position: absolute;display: table;width: 10%;height: 5%;left: 60.2%;top: 42%;}
</style>
<!-----------------------------------Student personal Info Field--------------------------------------------------------------->
<!-----------------------------------Pagination Buttons-------------------------------------------------------------------------------->
...
<script src="<?= base_url('assets/js/frontend/profile_student.js') ?>" type="text/javascript"></script>