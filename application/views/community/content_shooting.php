...
<div class="bg">
    <img src="<?= base_url('assets/images/frontend/community/shooting/bg.png')?>" class="background_image">
</div>
...
<div class="shooting-content">
    <video controls style="background:#fff" autoplay>
