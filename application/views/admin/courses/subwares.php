                                ...
                                <form action="#" class="form-horizontal">
                                    <div class="form-body">
                                        <div class="form-group">
                                            <label class="col-md-4 control-label"><?php echo $this->lang->line('SubwareName');?>:</label>
                                            <div class="col-md-8">
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="swInfo_tbl">
                            ...
                            <tr>
                                ...
                                <th style="width:13%;"><?php echo $this->lang->line('SubwareName');?></th>
                                <th style="width:25%;"><?php echo $this->lang->line('CourseName');?></th>
                                <th style="width:10%;"><?php echo $this->lang->line('UnitName');?></th>
                                <th style="width:13%;"><?php echo $this->lang->line('CoursewareName');?></th>
                            ...
                            <?php foreach($subwares as $subware):
                                $pub = '';
                                if($subware->publish=='1')  $pub = $this->lang->line('Publish');
                                else   $pub = $this->lang->line('UnPublish');
                                ?>
                                <tr>
...
<script type="text/javascript">
    ...
    $('#subware_menu').css('background-color','black');
