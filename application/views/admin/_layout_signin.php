...
<head>
    ...
    <link href="<?= base_url('assets/admin/global/css/components.min.css')?>" rel="stylesheet" id="style_components" type="text/css" />
    <link href="<?= base_url('assets/admin/global/css/plugins.min.css')?>" rel="stylesheet" type="text/css" />
    <!-- END THEME GLOBAL STYLES -->
    <!-- BEGIN PAGE LEVEL STYLES -->
    <link href="<?= base_url('assets/admin/pages/css/login.min.css')?>" rel="stylesheet" type="text/css" />
...
<script src="<?= base_url('assets/admin/pages/scripts/login.min.js')?>" type="text/javascript"></script>
