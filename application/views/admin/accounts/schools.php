                                ...
                                <form action="#" class="form-horizontal">
                                    <div class="form-body">
                                        <div class="form-group">
                                            <label class="col-md-4 control-label"><?php echo $this->lang->line('SchoolName');?>:</label>
                                            <div class="col-md-8">
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="schoolInfo_tbl">
                            ...
                            <tr>
                                ...
                                <th style="width:15%;"><?php echo $this->lang->line('SchoolName');?></th>
                                <th style="width:40%;"><?php echo $this->lang->line('Grade/Class');?></th>
                                <th style="width:30%;"><?php echo $this->lang->line('Operation');?></th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php foreach($schools as $school):
                                ...
                                ?>
                                <tr>
                                  <td align="center"><?php echo $school->school_id; ?></td>
                                  <td align="center"><?php echo $school->school_name;?></td>
                                  <td align="center">
                                     <?php
                                           ...
                                           foreach ($classArr as $class_info):
                                             ...
                                             for($i=1;$i<=$class_info->class;$i++)
                                             {
                                                 ...
                                                 if($i==$class_info->class){
                                                     echo $realStr.$gradeStr.$i.$classStr;
                                                 }else{
                                                     echo $realStr.$gradeStr.$i.$classStr.$seperator;
                                                 }
                                             }
                                             echo '<br/>';
                                           endforeach;
                                  ...
                                  <td align="center">
                                      <button class="btn btn-sm btn-success" onclick="edit_school(this);"    school_id = <?php echo $school->school_id;?>><?php echo $this->lang->line('Modify');?></button>
                                      <button class="btn btn-sm btn-warning" onclick="delete_school(this);"  school_id = <?php echo $school->school_id;?>><?php echo $this->lang->line('Delete');?></button>
                                      <button style="width:70px;" class="btn btn-sm btn-danger"  onclick="publish_school(this);" school_id = <?php echo $school->school_id;?>><?php echo $stop;?></button>
                                  </td>
                                </tr>
                            <?php endforeach;?>
                            </tbody>
    ...
    <div class="modal-body">
        <form class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <input type="text" class="form-control" name="add_school_name" id="add_school_name" value="">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <table class="table custom_tbl_borderless">
                        <tr>
                            <td>
                                <label class="mt-checkbox mt-checkbox-outline">
                                    <input type="checkbox" id="edit_first_chk"><?php echo $this->lang->line('One')."&nbsp".$this->lang->line('Grade');?>
                                    <span></span>
                                </label>
                            </td>
                            <td>
                                <label class="mt-checkbox mt-checkbox-outline">
                                    <input type="checkbox" id="edit_second_chk"><?php echo $this->lang->line('Two')."&nbsp".$this->lang->line('Grade');?>
                                    <span></span>
                            ...
                            <td>
                                <label class="mt-checkbox mt-checkbox-outline">
                                    <input type="checkbox" id="edit_third_chk"><?php echo $this->lang->line('Three')."&nbsp".$this->lang->line('Grade');?>
                                    <span></span>
                                </label>
                            </td>
                            <td>
                                <label class="mt-checkbox mt-checkbox-outline">
                                    <input type="checkbox" id="edit_fourth_chk"><?php echo $this->lang->line('Four')."&nbsp".$this->lang->line('Grade');?>
                                    <span></span>
                                </label>
                            </td>
                            <td>
                                <label class="mt-checkbox mt-checkbox-outline">
                                    <input type="checkbox" id="edit_fifth_chk"><?php echo $this->lang->line('Five')."&nbsp".$this->lang->line('Grade');?>
                                    <span></span>
                                </label>
                            </td>
                        </tr>
                        <tr>
                            <td id = "edit_first_grade_col">
                                <label class = "custom_grade_label" id = "edit_first_grade_classCnt">1</label>
                                <label><?php echo $this->lang->line('Ge').$this->lang->line('Class');?></label>
                                <button type="button" id = "edit_plus_first_grade_btn">&#43</button>
                                <button type="button" id = "edit_minus_first_grade_btn">&#8211</button>
                            </td>
                            <td id = "edit_second_grade_col">
                                <label class = "custom_grade_label" id = "edit_second_grade_classCnt">1</label>
                                <label><?php echo $this->lang->line('Ge').$this->lang->line('Class');?></label>
                                <button type="button" id = "edit_plus_second_grade_btn">&#43</button>
                                <button type="button" id = "edit_minus_second_grade_btn">&#8211</button>
                            </td>
                            <td id = "edit_third_grade_col">
                                <label class = "custom_grade_label" id = "edit_third_grade_classCnt">1</label>
                                <label><?php echo $this->lang->line('Ge').$this->lang->line('Class');?></label>
                                <button type="button" id = "edit_plus_third_grade_btn">&#43</button>
                                <button  type="button" id = "edit_minus_third_grade_btn">&#8211</button>
                            </td>
                            <td id = "edit_fourth_grade_col">
                                <label class = "custom_grade_label" id = "edit_fourth_grade_classCnt">1</label>
                                <label><?php echo $this->lang->line('Ge').$this->lang->line('Class');?></label>
                                <button type="button" id = "edit_plus_fourth_grade_btn">&#43</button>
                                <button  type="button" id = "edit_minus_fourth_grade_btn">&#8211</button>
                            </td>
                            <td id = "edit_fifth_grade_col">
                                <label class = "custom_grade_label" id = "edit_fifth_grade_classCnt">1</label>
                                <label><?php echo $this->lang->line('Ge').$this->lang->line('Class');?></label>
...
<script>
    ...
    $('#school_menu').css('background-color','black');
