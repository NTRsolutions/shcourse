                ...
                <div class="portlet light bordered">
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="userDownLoadInfo_tbl">
                            <thead>
                            <tr>
                                <th style="width:10%" ><?php echo $this->lang->line('Account');?></th>
                                ...
                                <th style="width:15%"><?php echo $this->lang->line('School');?></th>
                            ...
                            ?>
                               <tr>
                                    ...
                                    <td><?php echo $users['school_name'];?></td>
                        ...
                        <div class="row">
                        <div class="col-md-2" id="downloadpageNavPosition"></div>
