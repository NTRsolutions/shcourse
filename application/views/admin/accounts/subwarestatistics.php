                ...
                <div class="portlet light bordered">
                    <div class="table-toolbar" style="margin-bottom: 0;">
                        <div class="form-group">
                            ...
                            <a class="btn btn-md yellow"  href="<?= base_url('admin/statistics/subwares') ?>"><?php echo $this->lang->line('SubwareAccessStatistics');?></a>
                        </div>
                        <form action="subwares" method="post" class="form-horizontal" id="sw_access_search_form">
                            <div class="form-group">
                                <label class="col-md-1 control-label"><?php echo $this->lang->line('SubwareName');?>:</label>
                                <div class="col-md-2" style="padding-left: 0;padding-right: 0;">
                                    <input type="text" class="form-control" name = "sw_type_name_search" placeholder="" value="<?php echo $sw_type_name_value; ?>">
                                </div>
                    ...
                    <div class="portlet-body">
                        <div id="swAccessChart" style="height:630px;"></div>
                    </div>
                </div>
...
<?php foreach($swAccessSets as $swAccess):?>
    <script>
        var eachItem = {x:'<?php echo $swAccess['sw_type_name'];?>',value:<?php echo $swAccess['visit_num'];?>,fill: "#fcc",stroke: null};
        data.push(eachItem);
    </script>
<?php endforeach;?>
