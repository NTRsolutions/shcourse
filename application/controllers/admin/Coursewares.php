...
class Coursewares extends Admin_Controller
{
    ...
    public function output_content($cwsets)
    {
        ...
        foreach( $cwsets as $cw):
            ...
            $output .= '<td align="center">'.$cw->unit_type_name.'</td>';
            $output .= '<td align="center">'.$cw->course_name.'</td>';
            $output .= '<td align="center">'.$cw->school_type_name.'</td>';
            $output .= '<td align="center">';
            $output .=  '<button class="btn btn-sm btn-success" onclick = "edit_cw(this);" cw_id = '.$cw->courseware_id.'>'.$this->lang->line('Modify').'</button>';
